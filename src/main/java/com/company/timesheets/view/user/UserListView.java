...
public class UserListView extends StandardListView<User> {
    ...
    @Subscribe("usersDataGrid.sendEmailAction")
    public void onUsersDataGridSendEmailAction(final ActionPerformedEvent event) {
...
//                .open();
    ...
    private class EmailTask extends BackgroundTask<Integer, Void> {
        ...
        protected EmailTask(String title, String body, Collection<User> users) {
            super(10, TimeUnit.SECONDS, UserListView.this);
            this.title = title;
            this.body = body;
            this.users = users;
        }
        ...
        public void done(Void result) {
            notifications.create("Completed")
